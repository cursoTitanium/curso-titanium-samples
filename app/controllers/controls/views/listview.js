...
var controller = (function constructor(args) {
	...
	(function bindEvents() {
		...
		//Añadimos listener a lista
		$.addListener($.list, "itemclick", onItemClick);
	})();

	/**
	 * onItemClick
	 * @description Callback tras pulsar sobre una fila
	 * @param {Object} e Evento con información del callback
	 */
	function onItemClick(e){
		console.log("onItemClick");
		
		Alloy.Globals.toast("Click sobre fila en sección " + e.sectionIndex  + " y fila " + e.itemIndex);
	}
