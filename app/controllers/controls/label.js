...
var controller = (function constructor(args) {
	...
	(function bindEvents() {
		...
		["left", "center", "right"].forEach(function(alignButton) {
			$.addListener($[alignButton], "click", alignText);
		});
	})();

	/**
	 * alignText
	 * @description Establece la alineación de la etiqueta
	 * @param {Object} e Evento de callback
	 */
	function alignText(e) {
		console.log("alignText");

		//Podemos utilizar las constantes de UI
		//Ti.UI.TEXT_ALIGNMENT_LEFT
		//Ti.UI.TEXT_ALIGNMENT_CENTER
		//Ti.UI.TEXT_ALIGNMENT_RIGHT
		//o bien left, center o right
		var align = e.source.id;

		//Establecemos alineación de texto dinámicamente
